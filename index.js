...
let strInput = prompt("Write a sentence about your favourite fruit");

// store string into new variable

let removeWhitespace = (strInput) => {
  return strInput.replace(/\s/g, "");
};

let output = removeWhitespace(strInput);
